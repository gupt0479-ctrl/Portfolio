        ...
        {list.map((item) => {
          ...
          return (
            <div
              key={item._id}
              className={[
                "group flex gap-4 border-b border-white/[0.06] py-5 transition-colors duration-150 ease-out",
            ...
            >
              <div className="flex w-16 shrink-0 flex-col items-start gap-1.5">
                <div className="flex min-h-[10px] items-center gap-2">
                  ...
                  <span className="font-mono text-xs text-white/30">{year}</span>
                </div>
              </div>
              ...
              <div className="min-w-0 flex-1 px-2 md:px-4">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {item.type ? (
                    <span className="rounded-full border border-white/20 px-2 py-0.5 text-[10px] text-white/35">
                      {item.type}
                    </span>
                  ) : null}
                </div>
