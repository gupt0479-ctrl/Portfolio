...
export async function AchievementsSection() {
  ...
  return (
    <section id="achievements" className="mx-auto max-w-6xl px-6 pt-3 pb-10">
      <div className="mb-4 text-center">
        <h2 className="text-xl md:text-2xl font-display font-semibold text-white/75">
          Achievements &amp; Awards
        </h2>
      </div>

      <CometCard variant="ghost" rotateDepth={2} translateDepth={5}>
