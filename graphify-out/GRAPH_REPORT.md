# Graph Report - portfolio  (2026-06-11)

## Corpus Check
- 135 files · ~63,715 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1114 nodes · 2023 edges · 102 communities (83 shown, 19 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `369dadea`
...
6. `Sanity Portfolio Local Fallback Data` - 17 edges
7. `getLocalDataForQuery()` - 16 edges
8. `Sanity Portfolio Dummy Data` - 16 edges
9. `useIridescentEffect()` - 15 edges
10. `urlFor()` - 14 edges
...
Cohesion: 0.07
Nodes (64): asBoolean(), asNumber(), asRecord(), asString(), asStringArray(), capitalize(), DATA_DIR, getLocalAchievements (+56 more)
...
Cohesion: 0.09
Nodes (38): cn(), Button(), buttonVariants, Card(), CardAction(), CardContent(), CardDescription(), CardFooter() (+30 more)
...
Cohesion: 0.12
Nodes (21): useIridescentEffect(), UseIridescentEffectOptions, formatCategory(), normalizeCategoryKey(), CTA_BUTTONS, IridCTA(), Profile, SocialLink (+13 more)
...
Cohesion: 0.08
Nodes (22): Architecture, Build Pipeline to Zero Errors, CLAUDE.md — Claude's Source of Truth, code:bash (pnpm typegen        # 1. Sync Sanity schema → src/sanity/typ), Commands, Content Flow, Current Architecture, Current Stack (+14 more)
...
Cohesion: 0.21
Nodes (8): builder, serverClient, token, assertValue(), dataset, projectId, structure(), schema

### Community 14 - "Community 14"
Cohesion: 0.19
Nodes (9): lora, metadata, RootLayout(), ubuntu, AppSidebar(), PortfolioLab(), clerkAppearance, Sidebar() (+1 more)
...
Cohesion: 0.21
Nodes (9): ACHIEVEMENTS_SECTION_QUERY, AchievementsSection(), CertificationsSection(), CERTS_SECTION_QUERY, CertWithSkills, Achievement, Certification, CometCard() (+1 more)
...
Cohesion: 0.14
Nodes (10): DegradedTemplates, detectIntent(), getDegradedNavigation(), getDegradedText(), Intent, NAV_PATTERNS, TEMPLATES, Persona (+2 more)
...
Cohesion: 0.21
Nodes (7): ChatTokenInit(), Orby, OrbyLoader(), Providers(), ThemeProvider(), generateMetadata(), SidebarProvider()

### Community 23 - "Community 23"
Cohesion: 0.24
Nodes (12): burstLimit, dailyLimit, isAllowedOrigin(), POST(), redis, buildSystemPrompt(), fetchCatalog(), getSanityClient() (+4 more)
...
Cohesion: 0.31
Nodes (8): AboutTelemetry(), client, hasUsableData(), live, loadLocalQueryResult(), sanityFetch(), ABOUT_QUERY, AboutSection()
...
Cohesion: 0.32
Nodes (10): getTechTags(), Project, ProjectCard(), ProjectCardProps, ProjectsSlider(), ProjectsSliderProps, slideVariants, SourceButton() (+2 more)
...
Cohesion: 0.3
Nodes (6): submitContactForm(), getSanityClient(), assertValue(), getServerClient(), ServerClient, token

### Community 33 - "Community 33"
Cohesion: 0.17
Nodes (11): ContactResult, GetResumeResult, LookupFactResult, NavigateResult, NONE_SENTINEL, SECTION_IDS, ShowExperienceResult, ShowProjectResult (+3 more)
...
Cohesion: 0.4
Nodes (6): ContactPanel(), ContactProfile, IridSocialButton(), SocialLinks, CONTACT_QUERY, ContactSection()
...
Cohesion: 0.31
Nodes (8): ChatTools, google, groq, isQuotaError(), LiveResult, routeChat(), RouterOpts, RouterResult

### Community 47 - "Community 47"
Cohesion: 0.36
Nodes (7): CANONICAL_READOUTS, CanonicalReadout, findStat(), SPARKLINE_BARS, STAT_ICONS, TelemetryCard(), TelemetryCardProps
...
Cohesion: 0.43
Nodes (4): SidebarToggle(), ORBIT_CHIPS, ProfileImage(), useSidebar()
...
## Knowledge Gaps
- **276 isolated node(s):** `client`, `experiencePatches`, `blogUrls`, `achievements`, `certPatches` (+271 more)
...
- **Why does `cn()` connect `Community 2` to `Community 1`, `Community 4`, `Community 38`, `Community 6`, `Community 11`, `Community 14`, `Community 17`, `Community 19`, `Community 22`, `Community 25`, `Community 28`, `Community 31`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `useSidebar()` connect `Community 52` to `Community 1`, `Community 2`, `Community 6`, `Community 14`, `Community 31`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `CometCard()` connect `Community 17` to `Community 2`, `Community 41`, `Community 26`, `Community 35`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **What connects `client`, `experiencePatches`, `blogUrls` to the rest of the system?**
